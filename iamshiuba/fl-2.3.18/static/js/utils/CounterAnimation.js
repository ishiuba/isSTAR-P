...
class CounterAnimation {
  ...
  animateCounter(counter) {
    ...
    const formatNumber = (num) => {
      // Check if there's a formatted target for large numbers
      const formattedTarget = counter.dataset.formattedTarget;
      if (formattedTarget && num >= target * 0.95) {
        // Use formatted version when close to target (95% or more)
